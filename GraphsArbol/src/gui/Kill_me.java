 ...
 * @author rick
 */
public class Kill_me extends javax.swing.JPanel
{
    ...
    private void endConnection(Point p)
    {
        ...
        if(start!=null && end!=null && (!(start.equals(end))))
        {
            ...
            drawConnection(getGraphics(),start,end,String.valueOf(peso),Color.BLACK);
        }
    }
    ...
    private int pedir_valor_arista()
    {
        while(true)
        {
            ...
            {
                JOptionPane.showMessageDialog(this, "solo admite valores numéricos");
            }
        }
    }
    
    private void drawConnection(Graphics g,Node s, Node e,String peso,Color c)
    {
        g.setColor(c);
    ...
    {
        Node<String> n = graphsarbol.GraphsArbol.grafo.getNodeAt(p);
        if(n!=null) return n;
    ...
    private void reloadGraph(Graphics g)
    {
        ...
        {
            drawConnection(g,con.getStart_point(),con.getEnd_point(),String.valueOf(con.getWeight()),Color.BLACK);
        });
        requestFocus();
    }
    
    
    public void mostrar_camino(ArrayList<Connection> arbol)
    {
        Graphics g = this.getGraphics();
        reloadGraph(g);
        arbol.forEach((arco) ->
        {
            drawConnection(g,arco.getStart_point(),arco.getEnd_point(),String.valueOf(arco.getWeight()),Color.GREEN);
        });
    }
    
    
    public Node     ant_selected,   //anterior nodo seleccionado
